...
def menuPrincipalMedicos (listaPersonas):#1.1.1
    ...
    if opMedico == "1":
        ...
        atenderPaciente(listaAtenderPacientes)
    elif opMedico =="4":
...
def insertarAtenderPacientes(listaAtenderPacientes): #Faltaria la manera de validar cedula con citas y citas de secretaria
    ...
    registroAtencionPaciente=AtencionPaciente(cedula,fecha,sintomas,nivelDolor,posicion,diagnostico,doctor)
    listaAtenderPacientes.append(registroAtencionPaciente)


def atenderPaciente(listaAtenderPacientes,id,listaCitas,):
    import time
